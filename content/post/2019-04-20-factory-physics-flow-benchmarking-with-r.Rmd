...
Cool! My simulation metamodel is quite equivalent to the marginal case.

## Tradeoff Frontiers

If we plot Throughput vs Leadtime, we obtain tradeoff limits that bounds the system's possible performance.
