...
Teaching MBA / MBE classes to seasoned managers is challenging. It's important to bring new thoughts to the table, and at the same time to provide a fundamental basis for experienced people with diverse backgrounds. One of the strategies I found to overcome these obstacles this week was to use a new analysis framework (in my case, Factory Physics concepts) and use that to challenge their views about existing frames they already master. In the end, I used a combination of concepts, Simulation Models, many-objective tradeoffs visuals (like the gif below) and tasks to challenge their intuition about manufacturing systems, while teaching the fundamentals of factory dynamics. 

![](/post/2019-data/many-objective-inventory-tradeoffs.gif) 

This post shares some of the [R](https://www.r-project.org/) code I developed while putting together course materials and is an example of how to use [simulation metamodeling](/post/des-metamodeling-splines-r-arena/) and Arena to Run Factory Physics' Flow Benchmarking.
