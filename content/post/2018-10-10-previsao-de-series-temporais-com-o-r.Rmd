...
# Introdução - O Objeto de Séries Temporais {data-background=imgs/background-1.jpg data-background-size=cover}
...
# Visualizando Séries Temporais {data-background=imgs/background-1.jpg data-background-size=cover}
...
# Importando Dados para o R {data-background=imgs/background-1.jpg data-background-size=cover}

## Criando Objetos 'ts' para Séries Temporais a partir de dados reais

- Para manipular séries temporais no R, é interessante criar objetos do tipo 'ts'.
- Podemos criar objetos a partir de arquivos do excel, csv, bases de dados, ou mesmo APIs públicas.

## Criando objetos 'ts' a partir do excel
...
# Previsões com Modelos Exponenciais {data-background=imgs/background-1.jpg data-background-size=cover}
...
## Suavização Exponencial Simples
- Exemplo da Aplicação da Equação:
